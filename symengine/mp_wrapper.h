...
#if SYMENGINE_INTEGER_CLASS == SYMENGINE_FLINT
SYMENGINE_EXPORT std::ostream &operator<<(std::ostream &os, const SymEngine::fmpq_wrapper &f);
SYMENGINE_EXPORT std::ostream &operator<<(std::ostream &os, const SymEngine::fmpz_wrapper &f);
#elif SYMENGINE_INTEGER_CLASS == SYMENGINE_GMP
SYMENGINE_EXPORT std::ostream &operator<<(std::ostream &os, const SymEngine::mpq_wrapper &f);
SYMENGINE_EXPORT std::ostream &operator<<(std::ostream &os, const SymEngine::mpz_wrapper &f);
#endif
