...
SYMENGINE_EXPORT void basic_new_stack(basic s);
//! Free the C++ class wrapped by s.
SYMENGINE_EXPORT void basic_free_stack(basic s);
...
SYMENGINE_EXPORT basic_struct *basic_new_heap(void);
SYMENGINE_EXPORT void basic_free_heap(basic_struct *s);

SYMENGINE_EXPORT const char *symengine_version(void);
...
SYMENGINE_EXPORT void basic_const_set(basic s, const char *c);

SYMENGINE_EXPORT void basic_const_zero(basic s);
SYMENGINE_EXPORT void basic_const_one(basic s);
SYMENGINE_EXPORT void basic_const_minus_one(basic s);
SYMENGINE_EXPORT void basic_const_I(basic s);

SYMENGINE_EXPORT void basic_const_pi(basic s);
SYMENGINE_EXPORT void basic_const_E(basic s);
SYMENGINE_EXPORT void basic_const_EulerGamma(basic s);
SYMENGINE_EXPORT void basic_const_Catalan(basic s);
SYMENGINE_EXPORT void basic_const_GoldenRatio(basic s);

//! Use these functions to get the use of positive, negative or unsigned
//! infinity as basic.
SYMENGINE_EXPORT void basic_const_infinity(basic s);
SYMENGINE_EXPORT void basic_const_neginfinity(basic s);
SYMENGINE_EXPORT void basic_const_complex_infinity(basic s);

//! Use this function to get the use of Nan as basic.
SYMENGINE_EXPORT void basic_const_nan(basic s);

//! Assign value of b to a.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_assign(basic a, const basic b);
...
SYMENGINE_EXPORT TypeID basic_get_class_id(const char *c);
//! Returns the class name of an object with the typeid `id`.
//! The caller is responsible to free the string with 'basic_str_free'
SYMENGINE_EXPORT char *basic_get_class_from_id(TypeID id);

//! Assign to s, a symbol with string representation c.
//! This function creates a new SymEngine::Symbol from a copy of
//! the string in c, thus the caller is free to use c afterwards.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE symbol_set(basic s, const char *c);

//! Returns 1 if s has value zero; 0 otherwise
SYMENGINE_EXPORT int number_is_zero(const basic s);
//! Returns 1 if s has negative value; 0 otherwise
SYMENGINE_EXPORT int number_is_negative(const basic s);
//! Returns 1 if s has positive value; 0 otherwise
SYMENGINE_EXPORT int number_is_positive(const basic s);
//! Returns 1 if s is complex; 0 otherwise
SYMENGINE_EXPORT int number_is_complex(const basic s);

//! Returns 1 if `e` contains the symbol `s`; 0 otherwise
SYMENGINE_EXPORT int basic_has_symbol(const basic e, const basic s);

//! Assign to s, a long.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE integer_set_si(basic s, long i);
//! Assign to s, a ulong.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE integer_set_ui(basic s, unsigned long i);
//! Assign to s, a mpz_t.
#ifdef HAVE_SYMENGINE_GMP
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE integer_set_mpz(basic s, const mpz_t i);
#endif
//! Assign to s, an integer that has base 10 representation c.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE integer_set_str(basic s, const char *c);
//! Assign to s, a real_double that has value of d.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE real_double_set_d(basic s, double d);
//! Returns double value of s.
SYMENGINE_EXPORT double real_double_get_d(const basic s);
...
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE real_mpfr_set(basic s, mpfr_srcptr m);
//! Assign to m, the mpfr_t given in s.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE real_mpfr_get(mpfr_ptr m, const basic s);
//! Returns the precision of the mpfr_t given by s.
SYMENGINE_EXPORT mpfr_prec_t real_mpfr_get_prec(const basic s);
#endif // HAVE_SYMENGINE_MPFR
...
SYMENGINE_EXPORT unsigned long integer_get_ui(const basic s);
//! Returns s as a mpz_t.
#ifdef HAVE_SYMENGINE_GMP
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE integer_get_mpz(mpz_t a, const basic s);
#endif
...
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE rational_set_mpq(basic s, const mpq_t i);
#endif
...
SYMENGINE_EXPORT int basic_neq(const basic a, const basic b);

//! Expands the expr a and assigns to s.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_expand(basic s, const basic a);
//! Assigns s = -a.
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_neg(basic s, const basic a);

//! Assigns s = abs(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_abs(basic s, const basic a);

//! Assigns s = erf(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_erf(basic s, const basic a);
//! Assigns s = erfc(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_erfc(basic s, const basic a);

//! Assigns s = sin(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_sin(basic s, const basic a);
//! Assigns s = cos(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_cos(basic s, const basic a);
//! Assigns s = tan(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_tan(basic s, const basic a);

//! Assigns s = asin(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_asin(basic s, const basic a);
//! Assigns s = acos(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_acos(basic s, const basic a);
//! Assigns s = atan(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_atan(basic s, const basic a);

//! Assigns s = csc(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_csc(basic s, const basic a);
//! Assigns s = sec(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_sec(basic s, const basic a);
//! Assigns s = cot(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_cot(basic s, const basic a);

//! Assigns s = acsc(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_acsc(basic s, const basic a);
//! Assigns s = asec(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_asec(basic s, const basic a);
//! Assigns s = acot(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_acot(basic s, const basic a);

//! Assigns s = sinh(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_sinh(basic s, const basic a);
//! Assigns s = cosh(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_cosh(basic s, const basic a);
//! Assigns s = tanh(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_tanh(basic s, const basic a);

//! Assigns s = asinh(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_asinh(basic s, const basic a);
//! Assigns s = acosh(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_acosh(basic s, const basic a);
//! Assigns s = atanh(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_atanh(basic s, const basic a);

//! Assigns s = csch(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_csch(basic s, const basic a);
//! Assigns s = sech(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_sech(basic s, const basic a);
//! Assigns s = coth(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_coth(basic s, const basic a);

//! Assigns s = acsch(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_acsch(basic s, const basic a);
//! Assigns s = asech(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_asech(basic s, const basic a);
//! Assigns s = acoth(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_acoth(basic s, const basic a);

//! Assigns s = lambertw(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_lambertw(basic s, const basic a);
//! Assigns s = zeta(a).
...
//! Assigns s = ceiling(a).
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_ceiling(basic s, const basic a);
//! Assigns s = sign(a).
...
SYMENGINE_EXPORT char *basic_str_julia(const basic s);
//! Printing mathml
SYMENGINE_EXPORT char *basic_str_mathml(const basic s);
//! Printing latex string
SYMENGINE_EXPORT char *basic_str_latex(const basic s);
//! Printing C code
SYMENGINE_EXPORT char *basic_str_ccode(const basic s);
//! Printing JavaScript code
SYMENGINE_EXPORT char *basic_str_jscode(const basic s);
//! Frees the string s
SYMENGINE_EXPORT void basic_str_free(char *s);

//! Assign boolean true to s
SYMENGINE_EXPORT void bool_set_true(basic s);
//! Assign boolean false to s
SYMENGINE_EXPORT void bool_set_false(basic s);

//! Assign the empty set to s
SYMENGINE_EXPORT void basic_set_emptyset(basic s);
//! Assign the universal set to s
SYMENGINE_EXPORT void basic_set_universalset(basic s);
//! Assign the complexes to s
SYMENGINE_EXPORT void basic_set_complexes(basic s);
//! Assign the reals to s
SYMENGINE_EXPORT void basic_set_reals(basic s);
//! Assign the rationals to s
SYMENGINE_EXPORT void basic_set_rationals(basic s);
...
SYMENGINE_EXPORT int basic_set_is_proper_subset(const basic a, const basic b);
//! Is a a superset of b
SYMENGINE_EXPORT int basic_set_is_superset(const basic a, const basic b);
//! Is a a proper superset of b
SYMENGINE_EXPORT int basic_set_is_proper_superset(const basic a, const basic b);
//! Assign the infimum of a to s
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_set_inf(basic s, const basic a);
...
SYMENGINE_EXPORT int symengine_have_component(const char *c);

//! Return 1 if s is a Number, 0 if not.
SYMENGINE_EXPORT int is_a_Number(const basic s);
//! Return 1 if s is an Integer, 0 if not.
SYMENGINE_EXPORT int is_a_Integer(const basic s);
//! Return 1 if s is a Rational, 0 if not.
SYMENGINE_EXPORT int is_a_Rational(const basic s);
//! Return 1 if s is a Symbol, 0 if not.
SYMENGINE_EXPORT int is_a_Symbol(const basic s);
//! Return 1 if s is a Complex, 0 if not.
SYMENGINE_EXPORT int is_a_Complex(const basic s);
//! Return 1 if c is a RealDouble, 0 if not.
SYMENGINE_EXPORT int is_a_RealDouble(const basic c);
//! Return 1 if c is a ComplexDouble, 0 if not.
SYMENGINE_EXPORT int is_a_ComplexDouble(const basic c);
//! Return 1 if c is a RealMPFR, 0 if not.
SYMENGINE_EXPORT int is_a_RealMPFR(const basic c);
//! Return 1 if c is a ComplexMPC, 0 if not.
SYMENGINE_EXPORT int is_a_ComplexMPC(const basic c);
//! Return 1 if c is a Set, 0 if not.
SYMENGINE_EXPORT int is_a_Set(const basic c);

//! Wrapper for std::vector<int>

typedef struct CVectorInt CVectorInt;

SYMENGINE_EXPORT CVectorInt *vectorint_new(void);
...
SYMENGINE_EXPORT int vectorint_placement_new_check(void *data, size_t size);
SYMENGINE_EXPORT CVectorInt *vectorint_placement_new(void *data);

SYMENGINE_EXPORT void vectorint_placement_free(CVectorInt *self);

SYMENGINE_EXPORT void vectorint_free(CVectorInt *self);
SYMENGINE_EXPORT void vectorint_push_back(CVectorInt *self, int value);
SYMENGINE_EXPORT int vectorint_get(CVectorInt *self, int n);
...
SYMENGINE_EXPORT CWRAPPER_OUTPUT_TYPE basic_max(basic s, const CVecBasic *d);
...
SYMENGINE_EXPORT CDenseMatrix *dense_matrix_new(void);
SYMENGINE_EXPORT CSparseMatrix *sparse_matrix_new(void);
...
SYMENGINE_EXPORT int is_a_DenseMatrix(const CDenseMatrix *c);
//! Return 1 if c is a SparseMatrix, 0 if not.
SYMENGINE_EXPORT int is_a_SparseMatrix(const CSparseMatrix *c);

//! Return 1 if lhs == rhs, 0 if not
SYMENGINE_EXPORT int dense_matrix_eq(CDenseMatrix *lhs, CDenseMatrix *rhs);
//! Return 1 if lhs == rhs, 0 if not
SYMENGINE_EXPORT int sparse_matrix_eq(CSparseMatrix *lhs, CSparseMatrix *rhs);

//! Wrapper for set_basic

SYMENGINE_EXPORT CSetBasic *setbasic_new(void);
SYMENGINE_EXPORT void setbasic_free(CSetBasic *self);
//! Returns 1 if insert is successful and 0 if set already contains the value
//! and insertion is unsuccessful
SYMENGINE_EXPORT int setbasic_insert(CSetBasic *self, const basic value);
SYMENGINE_EXPORT void setbasic_get(CSetBasic *self, int n, basic result);
//! Returns 1 if value is found in the set and 0 if not
SYMENGINE_EXPORT int setbasic_find(CSetBasic *self, basic value);
//! Returns 1 if value was erased from the set and 0 if not
SYMENGINE_EXPORT int setbasic_erase(CSetBasic *self, const basic value);
SYMENGINE_EXPORT size_t setbasic_size(CSetBasic *self);
...
SYMENGINE_EXPORT char *ascii_art_str(void);
